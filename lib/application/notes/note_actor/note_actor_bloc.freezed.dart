...
@pragma('vm:prefer-inline') @override $Res call({Object? note = null,}) {
  return _then(NoteActorEvent.deleted(
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _Initail value)?  initial,TResult Function( _DeleteInProgress value)?  deleteInProgress,TResult Function( _DeleteFailure value)?  deleteFailure,TResult Function( _DeleteSuccess value)?  deleteSuccess,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _Initail() when initial != null:
return initial(_that);case _DeleteInProgress() when deleteInProgress != null:
return deleteInProgress(_that);case _DeleteFailure() when deleteFailure != null:
return deleteFailure(_that);case _DeleteSuccess() when deleteSuccess != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _Initail value)  initial,required TResult Function( _DeleteInProgress value)  deleteInProgress,required TResult Function( _DeleteFailure value)  deleteFailure,required TResult Function( _DeleteSuccess value)  deleteSuccess,}){
final _that = this;
switch (_that) {
case _Initail():
return initial(_that);case _DeleteInProgress():
return deleteInProgress(_that);case _DeleteFailure():
return deleteFailure(_that);case _DeleteSuccess():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _Initail value)?  initial,TResult? Function( _DeleteInProgress value)?  deleteInProgress,TResult? Function( _DeleteFailure value)?  deleteFailure,TResult? Function( _DeleteSuccess value)?  deleteSuccess,}){
final _that = this;
switch (_that) {
case _Initail() when initial != null:
return initial(_that);case _DeleteInProgress() when deleteInProgress != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  deleteInProgress,TResult Function( NoteFailure noteFailure)?  deleteFailure,TResult Function()?  deleteSuccess,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initail() when initial != null:
return initial();case _DeleteInProgress() when deleteInProgress != null:
return deleteInProgress();case _DeleteFailure() when deleteFailure != null:
return deleteFailure(_that.noteFailure);case _DeleteSuccess() when deleteSuccess != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  deleteInProgress,required TResult Function( NoteFailure noteFailure)  deleteFailure,required TResult Function()  deleteSuccess,}) {final _that = this;
switch (_that) {
case _Initail():
return initial();case _DeleteInProgress():
return deleteInProgress();case _DeleteFailure():
return deleteFailure(_that.noteFailure);case _DeleteSuccess():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  deleteInProgress,TResult? Function( NoteFailure noteFailure)?  deleteFailure,TResult? Function()?  deleteSuccess,}) {final _that = this;
switch (_that) {
case _Initail() when initial != null:
return initial();case _DeleteInProgress() when deleteInProgress != null:
return deleteInProgress();case _DeleteFailure() when deleteFailure != null:
...
class _Initail implements NoteActorState {
  const _Initail();
...
class _DeleteInProgress implements NoteActorState {
  const _DeleteInProgress();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _DeleteInProgress);
}
...
@override
String toString() {
  return 'NoteActorState.deleteInProgress()';
}

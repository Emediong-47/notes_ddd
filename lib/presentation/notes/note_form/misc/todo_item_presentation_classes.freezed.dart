...
mixin _$TodoItemPrimitive {
 ...
 UniqueId get id; String get name; bool get isDone;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TodoItemPrimitive&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.isDone, isDone) || other.isDone == isDone));
}
...
@useResult
$Res call({
 UniqueId id, String name, bool isDone
});
...
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? isDone = null,}) {
  return _then(TodoItemPrimitive(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( UniqueId id,  String name,  bool isDone)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TodoItemPrimitive() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( UniqueId id,  String name,  bool isDone)  $default,) {final _that = this;
switch (_that) {
case _TodoItemPrimitive():
return $default(_that.id,_that.name,_that.isDone);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( UniqueId id,  String name,  bool isDone)?  $default,) {final _that = this;
switch (_that) {
case _TodoItemPrimitive() when $default != null:
return $default(_that.id,_that.name,_that.isDone);case _:
  return null;
...
class _TodoItemPrimitive extends TodoItemPrimitive {
  const _TodoItemPrimitive({required this.id, required this.name, required this.isDone}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TodoItemPrimitive&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.isDone, isDone) || other.isDone == isDone));
}

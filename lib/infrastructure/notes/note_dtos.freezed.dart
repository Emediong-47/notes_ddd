...
@JsonKey(includeFromJson: false, includeToJson: false) String? get id; String get body; int get colour; List<TodoItemDto> get todos;@ServerTimestampConverter() FieldValue get serverTimeStamp;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NoteDto&&(identical(other.id, id) || other.id == id)&&(identical(other.body, body) || other.body == body)&&(identical(other.colour, colour) || other.colour == colour)&&const DeepCollectionEquality().equals(other.todos, todos)&&(identical(other.serverTimeStamp, serverTimeStamp) || other.serverTimeStamp == serverTimeStamp));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,body,colour,const DeepCollectionEquality().hash(todos),serverTimeStamp);

@override
String toString() {
  return 'NoteDto(id: $id, body: $body, colour: $colour, todos: $todos, serverTimeStamp: $serverTimeStamp)';
}
...
@useResult
$Res call({
@JsonKey(includeFromJson: false, includeToJson: false) String? id, String body, int colour, List<TodoItemDto> todos,@ServerTimestampConverter() FieldValue serverTimeStamp
});
...
/// Create a copy of NoteDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? body = null,Object? colour = null,Object? todos = null,Object? serverTimeStamp = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(includeFromJson: false, includeToJson: false)  String? id,  String body,  int colour,  List<TodoItemDto> todos, @ServerTimestampConverter()  FieldValue serverTimeStamp)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NoteDto() when $default != null:
return $default(_that.id,_that.body,_that.colour,_that.todos,_that.serverTimeStamp);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(includeFromJson: false, includeToJson: false)  String? id,  String body,  int colour,  List<TodoItemDto> todos, @ServerTimestampConverter()  FieldValue serverTimeStamp)  $default,) {final _that = this;
switch (_that) {
case _NoteDto():
return $default(_that.id,_that.body,_that.colour,_that.todos,_that.serverTimeStamp);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(includeFromJson: false, includeToJson: false)  String? id,  String body,  int colour,  List<TodoItemDto> todos, @ServerTimestampConverter()  FieldValue serverTimeStamp)?  $default,) {final _that = this;
switch (_that) {
case _NoteDto() when $default != null:
return $default(_that.id,_that.body,_that.colour,_that.todos,_that.serverTimeStamp);case _:
  return null;
...
class _NoteDto extends NoteDto {
  const _NoteDto({@JsonKey(includeFromJson: false, includeToJson: false) this.id, required this.body, required this.colour, required  List<TodoItemDto> todos, @ServerTimestampConverter() required this.serverTimeStamp}): _todos = todos,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _NoteDto&&(identical(other.id, id) || other.id == id)&&(identical(other.body, body) || other.body == body)&&(identical(other.colour, colour) || other.colour == colour)&&const DeepCollectionEquality().equals(other._todos, _todos)&&(identical(other.serverTimeStamp, serverTimeStamp) || other.serverTimeStamp == serverTimeStamp));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,body,colour,const DeepCollectionEquality().hash(_todos),serverTimeStamp);
...
/// Create a copy of NoteDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? body = null,Object? colour = null,Object? todos = null,Object? serverTimeStamp = null,}) {
...
mixin _$TodoItemDto {
 ...
 String get id; String get name; bool get isDone;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TodoItemDto&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.isDone, isDone) || other.isDone == isDone));
}
...
/// Create a copy of TodoItemDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? isDone = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  bool isDone)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TodoItemDto() when $default != null:
return $default(_that.id,_that.name,_that.isDone);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  bool isDone)  $default,) {final _that = this;
switch (_that) {
case _TodoItemDto():
return $default(_that.id,_that.name,_that.isDone);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  bool isDone)?  $default,) {final _that = this;
switch (_that) {
case _TodoItemDto() when $default != null:
return $default(_that.id,_that.name,_that.isDone);case _:
  return null;
...
class _TodoItemDto extends TodoItemDto {
  const _TodoItemDto({required this.id, required this.name, required this.isDone}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TodoItemDto&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.isDone, isDone) || other.isDone == isDone));
}
...
/// Create a copy of TodoItemDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? isDone = null,}) {
